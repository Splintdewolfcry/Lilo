...
Tekil Karşıtlık (Isolated Opposition)
```
...
===
Karşıtlık gösteren parçalar arasında bağlantı yoksa
r ve l gibi (bu slayt örneği, ikisi ötümlü olduğu için ben tam anlamadım ama vardır bir bildiği hocamızın)
r: dilucu-dişeti, çarpmalı
l: dilucu-öndamak, yan daralmalı(akıcı)
```
...
Sesbilimsel bir ögenin varlığı yokluğu
k [-ötümlü]
g [+ötümlü]
```
...
===
Gradual Opposition
Yalnızca ünlüler için geçerlidir çünkü e nin değişkeleri gibi kapalı, yarı açık, açık gibi bir ayrım ünsüzlerde yok
Ünlü dörtgeni mantığından düşün
```
...
Eşdeğerli Karşıtlık?
===
Eqipollent Oppoisiton
Dilde karşıtlık gösteren parçalar mantıksal açıdan eşdeğerlilik gösteriyorsa
p : t ==~ t : k
```
...
===
Ana sınıf özellikleri
Birincil Yerleştirme Özellikleri
Ek Özellikler
```
...
===
Seçme-birleştirme (bu mekanizma disleksik bireylerdeki ses karıştırma durumunun seçme birleştirme sorunu olduğunu öne sürmektedir)
```
...
===
Patlamalı ve sürtümücü ünsüzler genelde duraklamalıdır (obstruents)
```
...
===
Seçilen ses, seslem yapısına göre yüzey yapıdan silinebilmektedir
